...
## Test Cases
You can find test cases for this KIP, please refer to [this link](https://github.com/darenft-labs/protocol-v2/blob/main/test/DataRegistry.ts#L579).
...
contract DataRegistry is IInscriptable, AccessControlUpgradeable, 
    ...
    returns (bool)
  {
    return 
      ...
      interfaceId == 0xd63e236c; // IInscriptable
  }
}
```
